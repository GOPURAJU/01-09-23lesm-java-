...
//					System.out.println("Profit/Loss" + profit_or_los);
			...
			if (Date1.isBefore(toDate) && Date2.isAfter(fromDate)) {
				...
				try {
					...
					expenses.setDaysOnBench(Total_benchDays - Total_client_days[0]);
					expenses.setBenchTenure(TotalDays);
					...
					expenses.setBR_INR(Math.ceil(Total_salary_from_client[0]));
					System.out.println(Math.ceil(Total_salary_from_client[0]));
					...
					expenses.setGPM_INR(Math.ceil(Total_salary_from_client[0]) - Math.ceil(Total_internal_pay));
					System.out.println(Math.ceil(Total_salary_from_client[0]) - Math.ceil(Total_internal_pay));

					long daysOnBench = Bench_tenure / 30;

					double benchpay = bench_pay(salary, MasterEmployee);
					System.out.println("benchpay===========" + benchpay);
					expenses.setBenchPay(Math.ceil(benchpay));
...
//	public double bench_pay(List<Salary> salarylist, MasterEmployeeDetails MasterEmployee, Double paid_tillnow) {
//
//		System.out.println("..............in bench pay .............");
//
//		LocalDate Date1 = null;
//		LocalDate Date2 = null;
//		LocalDate pos = null;
//		LocalDate poe = null;
//		List<EmployeesAtClientsDetails> clientlist = clientDetail
//				.findsBymasterEmployeeDetails_Id(MasterEmployee.getEmpId());
//
//		long i = 0;
//		double totalBenchpay = 0;
//
//		Double tempsal = 0.0;
//
//		for (Salary resolvenull : salarylist) {
//			if (resolvenull.getUpdatedAt() == null) {
//
//				int index = salarylist.indexOf(resolvenull);
//
//				resolvenull.setUpdatedAt(MasterEmployee.getJoiningDate());
//
//				salarylist.set(index, resolvenull);
//
//			}
//
//		}
//
//		salarylist.sort(Comparator.comparing(Salary::getUpdatedAt));
//
//		for (Salary resetnull : salarylist) {
//			if (resetnull.getUpdatedAt().equals(MasterEmployee.getJoiningDate())) {
//
//				int index = salarylist.indexOf(resetnull);
//
//				resetnull.setUpdatedAt(null);
//
//				salarylist.set(index, resetnull);
//
//			}
//
//		}
...
//			System.out.println("\nsalary=" + tempsal);
//
//			long salarydays = ChronoUnit.DAYS.between(Date1, Date2);
//			System.out.println("salarydays=" + salarydays);
//
//			if (!clientlist.isEmpty()) {
//
//				for (EmployeesAtClientsDetails client : clientlist) {
//
//					long clientDays = 0;
//
//					pos = client.getPOSdate();
//
//					poe = client.getPOEdate();
//
//					if (client.getClientJoiningDate() != null) {
//						pos = client.getClientJoiningDate();
//
//					}
//					if (client.getClientLastWorkingDate() != null) {
//						poe = client.getClientLastWorkingDate();
//					}
//
//					LocalDate systemdate = LocalDate.now();
//					try {
//						if (poe == null || systemdate.isBefore(poe)) {
//
//							poe = LocalDate.now();
//
//						}
...
//					}
//
//					if (pos.isBefore(Date2) || poe.isAfter(Date1))
//
//					{
//
//						if (poe.isBefore(Date2) && pos.isAfter(Date1)) {
//
//							clientDays = ChronoUnit.DAYS.between(pos, poe);
//							salarydays = salarydays - clientDays;
//
//							benchpay = salarydays * tempsal / 30;
//							totalBenchpay += benchpay;
//
//							System.out.println("\ndays=" + salarydays);
//							System.out.println("\nbenchpay=" + benchpay + " totalBenchpay=" + totalBenchpay);
//
//						} else if (pos.isBefore(Date1) && poe.isAfter(Date1) && poe.isBefore(Date2)) {
//
//							clientDays = ChronoUnit.DAYS.between(Date1, poe);
//							salarydays = salarydays - clientDays;
//
//							benchpay = salarydays * tempsal / 30;
//							totalBenchpay += benchpay;
...
//							System.out.println("\nbenchpay=" + benchpay + " totalBenchpay=" + totalBenchpay);
//
//						} else if (pos.isAfter(Date1) && pos.isBefore(Date2)
//								&& (poe.isAfter(Date2) || poe.isAfter(Date2))) {
//
//							clientDays = ChronoUnit.DAYS.between(pos, Date2);
//							salarydays = salarydays - clientDays;
//
//							benchpay = salarydays * tempsal / 30;
//							totalBenchpay += benchpay;
...
//					else {
//
//						System.out.println(" No clients in this tenure ");
//						benchpay = salarydays * tempsal / 30;
//						totalBenchpay += benchpay;
//						
//					}
...
//		}
//
//		if (MasterEmployee.getStatus() != EmployeeStatus.EXIT && MasterEmployee.getStatus() != EmployeeStatus.ABSCONDED
//				&& MasterEmployee.getStatus() != EmployeeStatus.TERMINATED)
//
//		{
//
...
//		else {
//
//			Date2 = releaseEmpDetailsRepository.findBymasterEmployeeDetails_Id(MasterEmployee.getEmpId()).get()
//					.getReleaseDate();
//
//			if (Date2 == null) {
//
//				System.out.println("=======================Error in Date 2 ");
//
//				return 0;
//			}
//
...
//
//					} else if (pos.isAfter(Date1) && pos.isBefore(Date2)
//							&& (poe.isEqual(Date2) || poe.isAfter(Date2))) {
//
//						clientDays = ChronoUnit.DAYS.between(pos, Date2);
//						salarydays = salarydays - clientDays;
//
//						benchpay = salarydays * tempsal / 30;
//						totalBenchpay += benchpay;
//						System.out.println("s=" + salarydays + "  c=" + clientDays);
//
//						System.out.println("\ndays=" + salarydays);
//						System.out.println("\nbenchpay=" + benchpay + " totalBenchpay=" + totalBenchpay);
//
...
//			System.out.println("No clients ");
//		}
//		return totalBenchpay;
//
//	}

	public double bench_pay(List<Salary> salarylist, MasterEmployeeDetails MasterEmployee) {
		...
		for (Salary record : salarylist) {
			...
			if (!clientlist.isEmpty()) {
				...
				for (EmployeesAtClientsDetails client : clientlist) {
					...
					if ((pos.isBefore(Date2) || pos.isEqual(Date2)) || (poe.isAfter(Date1) || poe.isEqual(Date1)))

					{

						if ((poe.isBefore(Date2) || poe.isEqual(Date2)) && pos.isAfter(Date1) || pos.isEqual(Date1)) {

							clientDays = ChronoUnit.DAYS.between(pos, poe);
							salarydays = salarydays - clientDays;

							System.out.println("\ndays=" + salarydays);
							System.out.println("client(" + pos + " to " + poe + ")\tclientdays=" + clientDays);

						} else if ((pos.isBefore(Date1) || pos.isEqual(Date1)) && poe.isAfter(Date1)
								|| (poe.isEqual(Date1)) && (poe.isEqual(Date2) || poe.isBefore(Date2))) {

							clientDays = ChronoUnit.DAYS.between(Date1, poe);
							salarydays = salarydays - clientDays;
							System.out.println("client(" + Date1 + " to " + poe + ")\tclientdays=" + clientDays);

							System.out.println("\ndays=" + salarydays);

						} else if ((pos.isAfter(Date1) || pos.isEqual(Date1)) && (pos.isBefore(Date2) || pos.isEqual(Date2))
								&& (poe.isAfter(Date2) || poe.isEqual(Date2))) {
					...
					}			System.out.println("client(" + pos + " to " + Date2 + ")\tclientdays=" + clientDays);
				...
				benchpay = salarydays * tempsal / 30;
				totalBenchpay += benchpay;
				System.out.println("\n....bp.." + benchpay + "....sd.." + salarydays + ".....tb......" + totalBenchpay);
